...
// 12-point IDFT tables (identical to the ones used by the gNB PUCCH0 receiver
// in PHY/NR_TRANSPORT/pucch_rx.c); the copy in defs_nr_common.h is commented out.
...
static int get_pucch0_cs_lut_index(PHY_VARS_NR_UE *ue, nfapi_nr_pucch_pdu_t* pucch_pdu) {
