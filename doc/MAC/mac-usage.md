...
If there is an already active PUCCH, it verifies if it can multiplex a HARQ feedback in the active
PUCCH or to select a HARQ instance where to multiplex the other active channels, pending checks including
