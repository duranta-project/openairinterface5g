...
from ntn_position import load_position
...
def calculate_directional_doppler(service_range_rate_ms, feeder_range_rate_ms,
                                  ...
                                  sat_type):
    """Return DL and UL Doppler shifts using positive range rate for recession."""
...
def calculate_ntn_delay_doppler(sat, ts, start_datetime, duration_sec, step_sec,
    ...
    """Return time offsets, one-way propagation delay, and DL/UL Doppler shifts."""
...
def main():
    ...
    print(f"Saved NTN profile generated from TLE data to {args.out_file} ({len(time_offsets)} samples)")
