...
"""Launch OAI NTN UE with initial frequency offset, timing drift, and updated position in UE configuration file."""
...
def main():
    ...
    parser.add_argument("--ue-config", help="UE config file whose position0 block will be updated")
